...
const (
	UsersService_GetUserByUsername_FullMethodName = "/proto.UsersService/GetUserByUsername"
)
...
type UsersServiceClient interface {
	GetUserByUsername(ctx context.Context, in *GetUserReq, opts ...grpc.CallOption) (*UserRes, error)
}
...
func (c *usersServiceClient) GetUserByUsername(ctx context.Context, in *GetUserReq, opts ...grpc.CallOption) (*UserRes, error) {
...
type UsersServiceServer interface {
	GetUserByUsername(context.Context, *GetUserReq) (*UserRes, error)
...
func (UnimplementedUsersServiceServer) GetUserByUsername(context.Context, *GetUserReq) (*UserRes, error) {
...
func _UsersService_GetUserByUsername_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsersServiceServer).GetUserByUsername(ctx, req.(*GetUserReq))
	}
